...
struct SimplifyMemFunc<SINGLE_MEMFUNCPTR_SIZE + 3*sizeof(int) >
{
	...
	inline static GenericClass *Convert(X *pthis, XFuncType function_to_bind, 
		...
		// stay out of trouble.
		// Occasionally, you might want to point direCBasicy to a derived class function
...
// It cannot be set to anything other than null, nor invoked direCBasicy: 
...
#define MakeFastFunction(x, func) fastdelegate::MakeDelegate(x, func)
