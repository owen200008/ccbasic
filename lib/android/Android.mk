...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/libevent-android
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../3rd/libevent/include
LOCAL_C_INCLUDES += $(LOCAL_PATH)/libevent_android/android
LOCAL_C_INCLUDES += $(LOCAL_PATH)/libiconv_android/jni/include
...
$(call import-module,libevent_android)
